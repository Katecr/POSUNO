...
namespace POSUNO.Api.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckUsersAsync()
        {
            ...
            {
                _context.Users.Add(new User {Email = "uno@yopmail.com", FirstName="Usuario", LastName="Prueba1", Password="123456"});
                _context.Users.Add(new User { Email = "dos@yopmail.com", FirstName = "Usuario", LastName = "Prueba2", Password = "123456" });
                await _context.SaveChangesAsync();
            }
        }
    }
